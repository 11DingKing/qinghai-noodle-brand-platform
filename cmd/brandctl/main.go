...
import (
	...
	"qinghainoodle/internal/applog"
	"qinghainoodle/internal/config"
	"qinghainoodle/internal/dispatch"
	"qinghainoodle/internal/repo"
	"qinghainoodle/internal/service"
)
...
func printUsage() {
	fmt.Fprintln(os.Stderr, `brandctl - operations CLI for lead responsibility adjudication service
